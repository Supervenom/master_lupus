...
public class NightOnePaparazzo extends Activity  {
	...
	/** Called when the activity is first created. */
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.nightonepaparazzo);
	        
	        Button next = (Button) findViewById(R.id.button8);
	        final EditText paparazzo = (EditText) findViewById(R.id.editText5);
	        final EditText choose = (EditText) findViewById(R.id.editText6);
	        ...
	        next.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
	            	String c = paparazzo.getText().toString();
	            	String d = choose.getText().toString();
	            	...
	            	while (!mCursor.isAfterLast()) {
	            		...
	            		if ((a.equals("paparazzo")) && (b.equals("label"))) break;
	            		mCursor.moveToNext();
	            	}
